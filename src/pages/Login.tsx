...
export default function Login() {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Primeiro, solicita o reset ao Supabase
      ...
      // Depois, envia o email personalizado via nossa edge function
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-4xl font-bold tracking-tight text-muted-foreground">
                {isForgotPassword ? "Recuperar senha" : isSignup ? "Crie sua conta" : "Bem-vindo a"}
              </h1>
              {!isSignup && !isForgotPassword && <Logo variant="full" animated={false} />}
            </div>
            ...
            {/* Social login first (não mostrar em esqueci senha) */}
            {!isForgotPassword && (
              <>
                <Button 
                  variant="outline" 
            ...
            {/* Email/Password form */}
            <form className="space-y-4" onSubmit={isForgotPassword ? handleForgotPassword : (isSignup ? handleSignup : handleEmailLogin)}>
              ...
              >
                {loading 
                  ...
                  : (isForgotPassword ? "Enviar link de recuperação" : isSignup ? "Criar conta" : "Continuar com email")}
              </Button>
            </form>
